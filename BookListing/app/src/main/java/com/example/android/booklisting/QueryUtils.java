...
public final class QueryUtils {
    ...
    public static ArrayList<BookEntry> extractEarthquakes(Activity context, String earthquakeJSON) {
        ...
        ArrayList<BookEntry> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < jsonEQFeatureArray.length(); i++) {
                ...
                earthquakes.add(new BookEntry(context,place, time)); //todo: title, author instead place, time
            }
    ...
    public static ArrayList<BookEntry> fetchBooks(Activity context) {
        ...
        ArrayList<BookEntry> events = extractEarthquakes(context, jsonResponse);
